...
func TestOrionClassicRoots(t *testing.T) {
...
func TestOrionRandomRoots(t *testing.T) {
	// generated by codegen4OrionRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01
 ║         ║
 ╠════════ B1.01
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeOrion(nodes, nil)
...
/*
// codegen4OrionRandomRoot is for test data generation.
func codegen4OrionRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeOrion(nodes)
	// process events
	config := inter.Events{}
