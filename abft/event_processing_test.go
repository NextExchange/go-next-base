...
func TestOrionRandom_1(t *testing.T) {
	testOrionRandom(t, []pos.Weight{1}, 0)
}

func TestOrionRandom_big1(t *testing.T) {
	testOrionRandom(t, []pos.Weight{math.MaxUint32 / 2}, 0)
}

func TestOrionRandom_big2(t *testing.T) {
	testOrionRandom(t, []pos.Weight{math.MaxUint32 / 4, math.MaxUint32 / 4}, 0)
}

func TestOrionRandom_big3(t *testing.T) {
	testOrionRandom(t, []pos.Weight{math.MaxUint32 / 8, math.MaxUint32 / 8, math.MaxUint32 / 4}, 0)
}

func TestOrionRandom_4(t *testing.T) {
	testOrionRandom(t, []pos.Weight{1, 2, 3, 4}, 0)
}

func TestOrionRandom_3_1(t *testing.T) {
	testOrionRandom(t, []pos.Weight{1, 1, 1, 1}, 1)
}

func TestOrionRandom_67_33(t *testing.T) {
	testOrionRandom(t, []pos.Weight{33, 67}, 1)
}

func TestOrionRandom_67_33_4(t *testing.T) {
	testOrionRandom(t, []pos.Weight{11, 11, 11, 67}, 3)
}

func TestOrionRandom_67_33_5(t *testing.T) {
	testOrionRandom(t, []pos.Weight{11, 11, 11, 33, 34}, 3)
}

func TestOrionRandom_2_8_10(t *testing.T) {
	testOrionRandom(t, []pos.Weight{1, 2, 1, 2, 1, 2, 1, 2, 1, 2}, 3)
}

// TestOrion's possibility to get consensus in general on any event order.
func testOrionRandom(t *testing.T, weights []pos.Weight, cheatersCount int) {
	assertar := assert.New(t)

	const lchCount = 3
	nodes := tdag.GenNodes(len(weights))

	lchs := make([]*TestOrion, 0, lchCount)
...
func compareResults(t *testing.T, lchs []*TestOrion) {
	assertar := assert.New(t)
